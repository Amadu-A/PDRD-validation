...
class ApplicationContainer:
    ...
    get_analysis_annotated_pdf: GetAnalysisAnnotatedPdf | None = None
...
def build_container() -> ApplicationContainer:
    ...
    visualization_cache = LocalFilesystemAnalysisVisualizationCache(
        root_path=artifact_root,
    )
    ...
    annotated_pdf_renderer = DocumentServiceAnalysisAnnotatedPdfRenderer(
        settings=(settings.document_service),
    )

    get_analysis_annotated_pdf = GetAnalysisAnnotatedPdf(
        get_analysis_job=(get_analysis_job),
        artifact_store=(artifact_store),
